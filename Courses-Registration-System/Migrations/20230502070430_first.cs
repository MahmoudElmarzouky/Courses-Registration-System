...
namespace CoursesRegistrationSystem.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoursPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseInstructors", x => new { x.CourseDateId, x.InstructorId });
                    table.ForeignKey(
                        name: "FK_CourseInstructors_CourseDates_CourseDateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseStudents", x => new { x.CourseDateId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_CourseStudents_CourseDates_CourseDateId",
                        column: x => x.CourseDateId,
                        principalTable: "CourseDates",
                        principalColumn: "CourseDateId",
                        onDelete: ReferentialAction.Cascade);
